...
df.loc[df['SaintScore']>0.9,'slightly significant ones (ss), moderately significant ones (ms), highly significant ones (hs), non significant ones(ns)']='hs'
df.loc[(df['SaintScore']<=0.9)&(df['SaintScore']>0.7),'slightly significant ones (ss), moderately significant ones (ms), highly significant ones (hs), non significant Ones(ns)']='ms'
df.loc[(df['SaintScore']<=0.7)&(df['SaintScore']>0.5),'slightly significant ones (ss), moderately significant ones (ms), highly significant ones (hs), non significant Ones(ns)']='ss'
df.loc[df['slightly significant ones (ss), moderately significant ones (ms), highly significant ones (hs), non significant Ones(ns)'].isnull(),'slightly significant ones (ss), moderately significant ones (ms), highly significant ones (hs), non significant Ones(ns)']='ns'

df= df.sort_values(by='slightly significant ones (ss), moderately significant ones (ms), highly significant ones (hs), non significant Ones(ns)')
