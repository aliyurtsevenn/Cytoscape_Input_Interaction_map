...
number_of_conditions= data[data.columns[1]][6]
gene_names_path= data[data.columns[1]][7]
gene_names_path2= data[data.columns[1]][8]
label1= data[data.columns[1]][9]
label2= data[data.columns[1]][10]
...
path='~/Downloads/SAINTexpress_v3.6.3__2018-03-09/bin/SAINTexpress-spc'

os.system("{} -L2 inter.txt pray.txt bait.txt".format(path))

# Now, we created result of the SAINTexpress, in the home path. I will move this to my SAINTexpress file

shutil.move("/home/a/list.txt",os.path.join(all_output_path,'SaintExpress'))
...
shutil.copy(os.path.join(os.path.join(all_output_path,'Omics Integrator'),'gbm_prize.txt'),'/home/a/Downloads/OmicsIntegrator-master/example/GBM')
...
'''
removed_files=os.listdir("/home/a/Downloads/OmicsIntegrator-master/results/KO")
for f in removed_files:
    os.remove(os.path.join("/home/a/Downloads/OmicsIntegrator-master/results/KO",f))

os.chdir("/home/a/Downloads/OmicsIntegrator-master/example/GBM")
os.system("python /home/a/Downloads/OmicsIntegrator-master/example/GBM/GBM_case_study.py")
...
source="/home/a/Downloads/OmicsIntegrator-master/results/KO"
